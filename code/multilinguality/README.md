...
`UPDATE: Max new tokens are 4096 for the nightly CI, kept short so the pipeline finishes quickly across all submissions. The final grading run would use 16,384 as stated in the project description.`
