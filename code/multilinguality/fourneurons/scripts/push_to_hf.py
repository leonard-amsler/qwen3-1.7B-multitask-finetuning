...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "checkpoint_dir",
        help="Path to the LoRA checkpoint directory to merge and push. If not provided, it will push the base model.",
    )
    args = parser.parse_args()

    if args.hf_repo.split("/")[1] not in [
        "safety_model", 
        "multilingual_model",
        "math_model",
        ...
        raise SystemExit("Invalid Hugging Face repository name. Must be one of: safety_model, multilingual_model, math_model, general_knowledge_model, group_model.")
